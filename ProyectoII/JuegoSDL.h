...
public:
	...
	enum  Texturas_t{
		...
		TPistola, TPildora, TBotePildora, TInterruptor, TControles, TKeypad, TEnter, TNegro, TEnemigo, TEnemigo2, TEnemigo3, TEnemigo4, TEnemigo5, TInvitacion, TDoctorT,TAnimacionEspejo,TBoss,/*TFondoMenu,*/ TFuente, Texturas_t_SIZE
	};
